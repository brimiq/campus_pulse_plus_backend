...
def seed_posts():
    ...
    sample_posts = [
        {
            "content": "The cafeteria food quality has really improved this semester! The new menu options are much better and more variety. Keep up the good work kitchen staff! ",
